...
const appointmentServiceOptions = ["Corporate", "Athlete", "Spine Care"];
...
function Hero() {
  return <section className="hero"><div className="container hero-grid">
    <div>
      ...
      <div className="actions"><Link className="btn" href="/contact#corporate-enquiries">Book a free Workforce Assessment</Link><Link className="btn btn-ghost" href="/services">Explore Our Services</Link></div>
      <div className="trust"><p className="trust-heading">Why it matters</p><div className="trust-stat"><p><b>80%</b> <small>of office workers experience MSK pain</small></p></div><div className="trust-stat"><p><b>#1</b> <small>MSK is the leading cause of workplace absence globally</small></p></div><div className="trust-stat"><p><b>34%</b> <small>productivity loss from unmanaged MSK pain</small></p></div></div>
    </div>
