...
export const metadata: Metadata = {
  ...
  description: "Evidence-based physiotherapy, spine care, injury rehabilitation and workplace wellness in Gayaza, Kampala.",
  icons: { icon: "/favicon.svg" },
  openGraph: {
    title: "CoreWell Uganda | Expert Physiotherapy. Stronger You.",
    description: "Evidence-based physiotherapy and musculoskeletal health in Gayaza, Kampala.",
